...
interface CandidateCheersTabProps {
  candidateId: string;
  onUpdate?: () => void;
}

export default function CandidateCheersTab({ candidateId, onUpdate }: CandidateCheersTabProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <span className="text-gray-500">
            숨김 <span className="font-bold text-gray-400">{hiddenCount}</span>
          </span>
          <span className="text-gray-500">
            전체 <span className="font-bold text-gray-900">{cheers.length}</span>
          </span>
        </div>
      </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{cheer.message}</p>
