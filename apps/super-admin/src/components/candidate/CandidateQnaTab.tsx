...
interface CandidateQnaTabProps {
  candidateId: string;
  onUpdate?: () => void;
}

export default function CandidateQnaTab({ candidateId, onUpdate }: CandidateQnaTabProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-gray-900">Q&A 관리</h3>
            {unansweredCount > 0 && (
          ...
          <p className="text-sm text-gray-500 mt-1">유권자 질문에 답변하고 관리합니다.</p>
        </div>
      </div>
          ...
          >
            ...
            <div className="p-4 border-t border-gray-100">
              <button
                ...
                className="w-full py-3 bg-blue-600 text-white rounded-xl font-semibold flex items-center justify-center gap-2 disabled:opacity-50 hover:bg-blue-700"
              >
                <Send size={18} />
